...
export default function Task4( props ){
    ...
    // ----------- [1] 1. onClick = { 함수명 } 또는 2. onClick = { ()=> { } } 함수 정의/대입 하는 코드
    // ----------- 3. 주의할점 : onClick={ 함수명()} 함수 실행하는 코드 

    // ----------- [2] 리스트 출력시 forEach 대신에 *** map *** 사용
    return (<>
